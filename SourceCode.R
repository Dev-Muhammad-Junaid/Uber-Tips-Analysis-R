...
ggplot(data,aes(x = as.integer(Day), color = 'Density')) + geom_histogram(aes(y = ..density.. ),bins = 40,  fill = '#24ADF3', alpha = 0.5) +  
...
ggplot(data,aes(x = as.integer(Hour), color = 'density')) + geom_histogram(aes(y = ..density.. ),bins = 45,  fill = '#24ADF3', alpha = 0.5) +  
...
ggplot(data,aes(x = as.integer(Weekday), color = 'density')) + geom_histogram(aes(y = ..density.. ),bins = 30,  fill = '#24ADF3', alpha = 0.5) +  
